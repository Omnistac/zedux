/**
 * This file is copied from @docusaurus/core/lib/babel/preset.js with the
 * addition of a `targets` field for the client build since Zedux does not
 * support ancient browsers. Chrome v80 is plenty good though.
 *
 * See https://docusaurus.io/docs/configuration#customizing-babel-configuration
 */
const { dirname } = require('path')

function getTransformOptions(isServer) {
  const absoluteRuntimePath = dirname(
