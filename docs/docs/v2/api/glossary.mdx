...
- React-hook equivalents, like [`injectEffect`](./injectors/injectEffect.mdx), [`injectMemo`](./injectors/injectMemo.mdx), and [`injectRef`](/not-done?path=./injectors/injectRef).
