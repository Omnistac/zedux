...
You can pass either an existing [ecosystem](../classes/Ecosystem) via the `ecosystem` prop or any number of [EcosystemConfig properties](../types/EcosystemConfig.mdx) via their respectively named props.
...
<Legend>
  ...
  <Item name="ecosystemConfig">
    See [the EcosystemConfig type](../types/EcosystemConfig.mdx) for all the other props and their types. The EcosystemConfig key names have a one-to-one mapping with props of this component.
...
- [The `EcosystemConfig` type](../types/EcosystemConfig.mdx)
