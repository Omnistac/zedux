...
An [unrestricted injector](../glossary.mdx#unrestricted-injector) that returns an array of [reasons](/not-done?path=../types/EvaluationReason.mdx) that explain why the current atom is evaluating.
...
<Legend>
  <Item name="Returns">
    An array of [EvaluationReasons](/not-done?path=../types/EvaluationReason.mdx) that explain why the current atom is evaluating.
