...
const myAtomInstance = rootEcosystem.load(myAtom, ['a param'])
```

See [the Dependency Injection tutorial](TODO:link), [`<EcosystemProvider />`](TODO:link), and [`ecosystem()`](TODO:link)
