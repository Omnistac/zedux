...
[Ions](../classes/Ion) use this injector internally to provide the `get` function as part of their [IonGetUtils](../types/IonGetUtils) and [IonSetUtils](../types/IonSetUtils) objects.
...
Required (in this overload). An [atom instance](../classes/AtomInstanceBase).
