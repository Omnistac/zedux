...
Required (in this overload). An [atom instance](../classes/AtomInstanceBase). Will register a dynamic dependency on the passed instance and return a tuple of the instance's current value and `setState` function.
