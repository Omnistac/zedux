...
- If an atom instance is force-destroyed while it has static dependents, those dependents will be informed of the destruction and actually will schedule an evaluation or render to create a new instance.
