...
There are 2 main design patterns around atom ecosystems. Choose the most appropriate for your app.
...
The global ecosystem can therefore be nice for simplicity. Some apps don't need any of the features AppProviders offer. And that's fine!

### App-Based Approach

![](/img/diagrams/atom-ecosystems-app-based.png)

In the app-based approach, you create one or more app ecosystems (by rendering AppProviders). These app ecosystems contain all app-scoped and local-scoped atoms, while the global ecosystem holds all global-scoped atoms.
...
Most apps will want to make use of the powerful features of AppProviders. The app-based approach is recommended in most situations.
