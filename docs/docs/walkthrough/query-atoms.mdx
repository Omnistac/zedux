...
The [Atom APIs](atom-apis) and [Suspense](suspense) walkthroughs taught how to set an atom instance's promise. But promises themselves innately carry state. For example:
