...
That's about it for the key features of Zedux. Be thou crowned king of the state. You're ready to jump in and get building! Check out the [advanced guides](../advanced/complex-params), addon packages like [`@zedux/immer`](../packages/immer) and [`@zedux/machines`](../packages/machines/overview), and the [API docs](../api/api-overview) as needed. Happy coding!
