...
Atom APIs are a convenient way to pass stores, exports, and promises around. You may find yourself working with multiple Atom APIs when using custom injectors. Atom APIs have a `.addExports()` method specifically for merging exports together from multiple sources:
...
:::tip
Click "Reset" in the above sandbox.
:::
