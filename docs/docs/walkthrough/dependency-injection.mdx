...
```tsx live ecosystemId=dependency-injection/setOverrides resultVar=Swapper
...
```tsx live ecosystemId=dependency-injection/addOverrides resultVar=Overrider
...
```tsx live ecosystemId=dependency-injection/simple resultVar=App
