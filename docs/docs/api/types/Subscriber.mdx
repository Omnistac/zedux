...
<Legend>
  ...
  <Item name="action">
    <p>
      ...
      child store, this action will be an{' '}
      <Link to="ActionChain">ActionChain</Link> containing metadata that can be
      used to reproduce the state update from this store for time travel.
    </p>
  </Item>
</Legend>
