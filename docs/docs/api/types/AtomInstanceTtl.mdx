...
Ttl can be set at the [ecosystem](../classes/Ecosystem#defaultttl), [atom](../classes/Atom#ttl), or atom instance levels. Setting a ttl at the atom instance level is the most flexible. You can do so using an [AtomApi](../classes/AtomApi#setttl).
