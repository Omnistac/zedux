...
The ActionChain is the key to Zedux' [store composition model](../../advanced/store-composition). ActionChains are just nested objects.
...
See [Zedux's `internalTypes`](../constants/internalTypes).
