...
<Legend>
  ...
  <Item name="hydrate">
    <p>
      A function that accepts a serialized value and transforms it into the
      proper data type expected by instances of this atom.
    </p>
    <p>
  ...
  <Item name="ttl">
    ...
    <Link to="../classes/Atom#ttl">Atom#ttl</Link>.
  </Item>
</Legend>
