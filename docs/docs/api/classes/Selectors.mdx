...
<Legend>
  ...
  <Item name="find">
    ...
    <p>
      ...
      when passed, returns the first found SelectorCache whose cacheKey includes
  ...
  <Item name="findAll">
    ...
    <Legend>
      ...
      <Item name="Returns">
        ...
        their <Link to="SelectorCache">SelectorCache</Link> instances.
      </Item>
    </Legend>
  </Item>
  <Item name="getCache">
  ...
  <Item name="getCacheKey">
    <p>
      Returns the fully qualified cache key string that this Selectors class
