...
All standard "atom instances" are actually instances of this class. When Zedux instantiates [atom templates](AtomTemplate) (and [ion templates](IonTemplate)), it's just creating instances of this class.
...
useAtomInstance(myAtom, ['b', 'a'])`}</Ts>
    ...
    <Sandbox
      ...
      resultVar="Shout"
    >{`const normalAtom = atom('normal', "row, row, row your boat gently lest I scream")\n
