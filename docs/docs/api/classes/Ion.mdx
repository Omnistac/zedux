...
Ions extend the Atom class. An ion's [state factory](../glossary#state-factory) receives a special [AtomGetters object](../types/AtomGetters) as its first parameter..
