...
<Legend>
  <Item name="addExports">
    ...
    <p>
      Merges the passed object into any already-set [exports](#exports) on this
      AtomApi. If no exports have been set yet on this AtomApi,{' '}
      <code>.addExports()</code> sets the exports.
    </p>
...
const overwriteExports = api(initialExports).setExports({ ...newExports })`}</Ts>
  ...
  <Item name="setPromise">
    <p>
      ...
      property of this AtomApi. If this AtomApi is returned from a state
      factory, the promise will be set as the atom instance's promise and will
      be used to cause React to suspend.
    </p>
    <p>
