...
<Legend>
  <Item name="getKeyHash">
    <p>Gets a string keyHash for a specific instance of this atom.</p>
    <p>Signature:</p>
    <Ts>{`getKeyHash = (ecosystem, params?) => keyhash`}</Ts>
    <p>
    ...
    <p>
      Zedux uses this internally to generate atom instance keyHashes. You won't
      typically call this.
    </p>
  </Item>
  <Item name="override">
