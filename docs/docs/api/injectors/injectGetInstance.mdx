...
[Ions](../classes/Ion) use this injector internally to provide the `getInstance` function as part of their [AtomGetters](../types/AtomGetters) and [AtomSetters](../types/AtomSetters) objects.

## Examples

<LiveEditor ecosystemId="injectGetInstance/example" resultVar="Seconds">{`
