...
[Ions](../classes/Ion) use this injector internally to provide the `getInstance` function as part of their [GetterUtils](../types/GetterUtils) and [SetterUtils](../types/SetterUtils) objects.
