...
[Ions](../classes/Ion) use this injector internally to provide the `get` function as part of their [GetterUtils](../types/GetterUtils) and [SetterUtils](../types/SetterUtils) objects.
