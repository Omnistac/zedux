...
<Tabs>
  ...
  <A extends AnyAtomTemplate>(atom: A, params: AtomParamsType<A>, operation?: string): AtomInstanceType<A>;
  <I extends AnyAtomInstance>(instance: I, params?: [], operation?: string): I;
}`)}
</Tabs>
