...
<Tabs>
  ...
  <A extends AtomBase<any, [...any], any, any, any, any>>(atom: A, params: AtomParamsType<A>, config?: ZeduxHookConfig): StateHookTuple<AtomStateType<A>, AtomExportsType<A>>;
  <AI extends AtomInstance<any, [...any], any, any, any>>(instance: AI, params?: [], config?: ZeduxHookConfig): StateHookTuple<AtomInstanceStateType<AI>, AtomInstanceExportsType<AI>>;
}`)}
</Tabs>
