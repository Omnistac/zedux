...
<Tabs>
  ...
  <A extends AnyAtomTemplate>(atom: A, params: AtomParamsType<A>, config?: ZeduxHookConfig): StateHookTuple<AtomStateType<A>, AtomExportsType<A>>;
  <I extends AnyAtomInstance>(instance: I, params?: [], config?: ZeduxHookConfig): StateHookTuple<AtomStateType<I>, AtomExportsType<I>>;
}`)}
</Tabs>
