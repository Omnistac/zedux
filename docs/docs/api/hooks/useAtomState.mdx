...
<Tabs>
  ...
  <A extends AnyAtom>(atom: A, params: AtomParamsType<A>, config?: ZeduxHookConfig): StateHookTuple<AtomStateType<A>, AtomExportsType<A>>;
  <AI extends AnyAtomInstance>(instance: AI, params?: [], config?: ZeduxHookConfig): StateHookTuple<AtomStateType<AI>, AtomExportsType<AI>>;
}`)}
</Tabs>
