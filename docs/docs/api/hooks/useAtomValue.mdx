...
<Tabs>
  ...
  <A extends AnyAtom>(atom: A, params: AtomParamsType<A>, config?: ZeduxHookConfig): AtomStateType<A>;
  <AI extends AnyAtomInstance>(instance: AI, params?: [], config?: ZeduxHookConfig): AtomStateType<AI>;
}`)}
</Tabs>
