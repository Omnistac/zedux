...
<Tabs>
  ...
  <A extends AtomTemplateBase<any, [], any>>(atom: A): AtomInstanceType<A>;
  <A extends AtomTemplateBase<any, [...any], any>>(atom: A, params: AtomParamsType<A>, config?: ZeduxHookConfig): AtomInstanceType<A>;
