...
This API is very low-level. Library authors and advanced users may want to make use of it. But:
...
```ts
const injectAtomKey = createInjector('injectAtomKey', partialInstance => ({
