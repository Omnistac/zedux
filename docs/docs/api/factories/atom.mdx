...
<Tabs>
  ...
  ): AtomTemplate<StoreStateType<StoreType>, Params, Exports, StoreType, PromiseType>\n
  // Catch-all
  <
    State = any,
    Params extends any[] = [],
  ...
  >(
    ...
    config?: AtomConfig<State>
  ): AtomTemplate<State, Params, Exports, StoreType, PromiseType>
} = <
  State = any,
  Params extends any[] = [],
  Exports extends Record<string, any> = Record<string, never>,
...
<Legend>
  <Item name="key">
    ...
    <p>
      ...
      <Link to="../ZeduxPlugin#instancereused">
