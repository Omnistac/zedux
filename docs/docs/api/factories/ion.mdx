...
<Tabs>
  ...
  ): IonTemplate<StoreStateType<StoreType>, Params, Exports, StoreType, PromiseType>\n
  // No Store
  <
    State = any,
    Params extends any[] = [],
  ...
  >(
    ...
    config?: AtomConfig<State>
  ): IonTemplate<State, Params, Exports, Store<State>, PromiseType>
  // Catch-all
  <
    State = any,
    Params extends any[] = [],
  ...
  >(
    ...
    config?: AtomConfig<State>
  ): IonTemplate<State, Params, Exports, StoreType, PromiseType>
}`)}
</Tabs>
