...
Now, even with these amazing tools, Zedux might be able to make your setup even better.

Zedux was designed specifically to manage highly volatile state in Omnistac's bond trading platform. If your app has extreme state management demands, especially involving sockets/RxJS, Zedux might be exactly what you're looking for.
...
Zedux's community is obviously very young (brand new!). There are no community plugins for it yet, but Zedux's [standardized primitives](#standardized-primitives) and extreme extensibility leave that door wide open. If you want to help shape the community and tools of a powerful state management system, or you've been wanting to get involved in OSS, Zedux is a ripe opportunity.
