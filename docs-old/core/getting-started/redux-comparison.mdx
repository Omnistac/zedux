...
- Your app is very big and Redux is starting to creak - either from performance slowdowns due to sheer volume or code bloat becoming difficult to maintain. Note! [Redux Toolkit](https://redux-toolkit.js.org/) can help with the latter.
